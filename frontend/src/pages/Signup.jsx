  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
        ...
        <p className="text-sm text-slate-500 mb-6">Start tracking eco-friendly travel today</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              name="password" type={showPwd ? 'text' : 'password'} placeholder="Password (min 6 chars)"
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <Link to="/signin" className="text-green-600 font-semibold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
